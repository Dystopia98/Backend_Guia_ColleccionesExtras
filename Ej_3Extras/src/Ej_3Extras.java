 ...
 *  datos repetidos. Para ello, se debe crear una clase llamada Libro que guarde
 *  la información de cada uno de los libros de una Biblioteca. La clase Libro debe
 ...
 *  todos sus datos y seteandolos en el Libro. Despues, ese Libro se guarda en el
 *  conjunto y se le pregunta al usuario si quiere crear otro Libro o no.
 * La clase Librería contendrá además los siguientes métodos:
 * --- Constructor por defecto.
 * --- Constructor con parámetros.
 * --- Métodos Setters/Getters
 * --- Método prestamo(): El usuario ingresa el título del libro que quiere prestar
 *      y se lo busca en el conjunto. Si está, se llama con ese objeto Libro al método.
 *     El método se incrementa de a uno, como un carrito de compras, el atributo
 *      ejemplares prestados, del libro que ingresó el usuario.
 *     Esto sucederá cada vez que se realice un préstamo del libro. No se podrán
 *      prestar libros de los que no se queden ejemplares disponibles para prestar.
 *     Devuelve true si se ha podido realizar la operación y false en caso contrario
 * --- Método devolución(): El usuario ingresa el título del libro que quiere devolver
 *      y se lo busca en el conjunto. Si está en el conjunto, se llama con ese objeto
 *      al método.
 *     El método decrementa de a uno, como un carrito de compras, el atributo ejemplares
 *      prestados, del libro seleccionado por el usuario.
